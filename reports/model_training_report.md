# Twitter Sentiment Analysis - Model Training Report

Generated on: 2026-07-30 22:37:58

## 1. Dataset Summary
- **Number of Raw Rows**: 1,600,000
- **Number of Raw Columns**: 6
- **Number of Positive Tweets**: 729,886
- **Number of Negative Tweets**: 743,297
...
- **Total Vocabulary Size**: 50,000
- **TF-IDF Feature Count**: 50,000

## 3. Model Comparison
| Model | Accuracy | Precision | Recall | F1 Score | Training Time |
| :--- | :---: | :---: | :---: | :---: | :---: |
| Multinomial Naive Bayes | 0.7766 | 0.7777 | 0.7687 | 0.7732 | 0.24s |
| Logistic Regression | 0.7952 | 0.7854 | 0.8073 | 0.7962 | 2.39s |
| **Linear SVM (Best)** | **0.7979** | **0.7870** | **0.8119** | **0.7992** | **15.62s** |

## 4. Final Selected Model
The classifier **Linear SVM** was automatically selected for deployment based on the highest F1-score.
